...
__C.YOLO.CLASSES = '/home/chenp/Yolov5_tf/class_label.txt'
...
__C.YOLO.WIDTH_SCALE_V5 = 0.25 # yolov5 small:0.50 / middle:0.75 / large:1.00 / extend:1.25
...
__C.TRAIN.ANNOT_PATH = '/home/chenp/Yolov5_tf/train_annotation.txt'
__C.TRAIN.BATCH_SIZE = 2 if __C.YOLO.NET_TYPE == 'darknet53' else 1
...
__C.TRAIN.INITIAL_WEIGHT = '/home/chenp/Yolov5_tf/checkpoint/yolov4_coco.ckpt' #'ckpts/yolov3_test-loss=24.0873.ckpt-27'
...
__C.TEST.ANNOT_PATH = '/home/chenp/Yolov5_tf/test_annotation.txt'
